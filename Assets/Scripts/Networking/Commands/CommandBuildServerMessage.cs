...
{
	[EngineMessageContract(39, typeof(CommandBuildServerMessage))]
	public class CommandBuildServerMessage : ForgeMessage
	{
		public int RequestId { get; set; }
		public int BuildingId { get; set; }

		public override IMessageInterpreter Interpreter => CommandBuildServerInterpreter.Instance;
