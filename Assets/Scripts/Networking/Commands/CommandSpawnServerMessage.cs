...
{
	[EngineMessageContract(42, typeof(CommandSpawnServerMessage))]
	public class CommandSpawnServerMessage : ForgeMessage
	{
		public int RequestId { get; set; }

		public override IMessageInterpreter Interpreter => CommandSpawnServerInterpreter.Instance;
