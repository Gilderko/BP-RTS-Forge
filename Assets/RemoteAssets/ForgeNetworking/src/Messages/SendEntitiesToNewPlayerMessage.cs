...
namespace Forge.Networking.Unity.Messages
{
	...
	public class SendEntitiesToNewPlayerMessage : ForgeMessage
	{
		...
		public IPlayerSignature[] OwnerIds { get; set; }
		...
		public override void Deserialize(BMSByte buffer)
		{
			...
			{
				OwnerIds[i] = ForgeSerializer.Instance.Deserialize<IPlayerSignature>(buffer);
		...
		public override void Serialize(BMSByte buffer)
		{
			...
			for (int i = 0; i < EntityCount; i++)
			{
				ForgeSerializer.Instance.Serialize(OwnerIds[i], buffer);
